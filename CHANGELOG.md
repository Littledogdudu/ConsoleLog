...
- 修复了2026.x.x版本与2025.3.x及之前的版本兼容性问题
...
- console.table仅支持data一个入参，因没有额外标识识别，故一键删除、注释和解注释无法识别插件生成还是手动添加，可在设置中自行配置是否针对console.table启用一键删除、注释和解注释
...
- 添加${filePath}占位符（文件相对路径）(由1327947094提出)
